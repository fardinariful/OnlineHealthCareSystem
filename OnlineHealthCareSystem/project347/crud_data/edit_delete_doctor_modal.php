<!-- Edit -->
<div class="modal fade" id="edit_doctor_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="edit_doctor.php">
                ...
                <div class="col-sm-2">
						<label class="control-label modal-label">Specialist:</label>
					</div>
					<div class="col-sm-10">
...
<!-- Delete -->
<div class="modal fade" id="delete_doctor_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">	
				...
				<h2 class="text-center"><?php echo $row['name'].' '.$row['email'].' '.$row['number'].' '.$row['date'].' '.$row['age'].' '.$row['address'].' '.$row['specialist'].' '.$row['qualification'].' '.$row['password']; ?></h2>
			</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="delete_doctor.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
