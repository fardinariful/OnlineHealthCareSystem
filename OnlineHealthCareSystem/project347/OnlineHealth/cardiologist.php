...
<body class="container display-4">
           <h1 class="text-blue shadow-lg">All The Doctor's Of  Cardiologist</h1><table class="table table-hover table-light">
  <thead>
    <tr>
...
include("translate.php");
       ...
       $query = "SELECT * 
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
						  ...
						  echo  "<h3><tr><th><a>{$row['f_name']}{$row['l_name']}</a></th></h3>";
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="pediatrics.php">Previous</a></li>
  <li class="next"><a href="home2.php">Back to home</a></li>
