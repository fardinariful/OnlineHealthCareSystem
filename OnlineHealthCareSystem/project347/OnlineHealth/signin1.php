	 ...
	 if(empty($name))
	  ...
	  elseif($pswd_len<=8)
	   ...
	   { 
        ...
        $query="INSERT INTO `onlinehealthcare_form` (`id`, `name`, `email`, `number`, `date`, `age`, `address`, `password`) VALUES ('$id', '$name', '$email', '$number', '$date', '$age', '$address', '$password')";
        mysqli_query($db, $query);
							$run= $success_msg="Thank You For Registration";
				
					 echo "<script> window.location='joinus1.php' </script> ";
...
?>
 ...
 <div class="container-fluid text-center bg-grey col-50 width-50% ">
   <form action = "signin1.php" method="POST" class="form-inline">
<div class="container ">
<h1>Patients Registration</h1><p>Please fill in this form to create an account.</p>
      <hr>
...
<input type="text"style="font-size:16px" placeholder="Enter Your Email Address"name="email"required>
