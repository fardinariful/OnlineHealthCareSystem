...
<h1 class="text-monocase text-capitalize text-center text-blue">All The Doctor's Schedule List Of  Gynecologist</h1>
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="surgeon.php">Previous</a></li>
  <li class="next "><a href="bone.php">Next</a></li>
</ul></div>
