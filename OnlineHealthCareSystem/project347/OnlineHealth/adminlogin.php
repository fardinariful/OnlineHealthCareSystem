...
?>
 ...
 <h1  class=" text-center font-weight-bold text-white ">Admin Login</h1>
  ...
  <form class="modal-content animate" action="adminlogin.php" method="post">
      ...
      <br/><input type="password" class="w3-input w3-border" placeholder="Enter Password" name="admin_pswd" style="width:100%" required>
        
      <br/>
        <button type ="submit" name="submit" value="login" class="w3-button w3-block w3-blue">Login</button>
        </div>
