...
<body class="container display-4">
           <h1 class="text-blue shadow-lg">All The Doctor's Of  Orthopedic</h1>
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="Gynae.php">Previous</a></li>
  <li class="next"><a href="pediatrics.php">Next</a></li>
</ul></div>
