...
<title> Patients_home_page</title>
</head>
...
<li><a href="http://localhost/crud_data/index_patient1.php">Register Patient List</a></li> 
...
<li><a href="http://localhost/crud_data/index22.php">My Appointments</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active">
        <img src="ser.jpg" alt="img1" width="1500" height="800" title="User Home Page">
