...
<table class="table table-hover table-white ">
  <thead>
    <tr>
      ...
      <th scope="col" class="text-center text-warning w3-blue">Specialist Name</th>
...
<tr><th class="text-center"><a href="Gynae.php">Gynecologist</a></th></tr>
<tr><th class="text-center"><a href="pediatrics.php">Pediatrics</a></th></tr>
<br><br>
<h2><div class="container ">
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="view_user_home_page.php">Previous </a></li> 
  <li class="center "><a href="home2.php">Back to home</a></li>
  <li class="next"><a href="view_users_appointment.php">Next </a></li>
</ul></div></h2></table>
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
