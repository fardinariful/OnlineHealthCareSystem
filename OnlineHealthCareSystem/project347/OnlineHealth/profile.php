...
<div class="w3-col 18 s12">
  ...
  <div class="w3-card-4  w3-white">
    <div class="w3-container">
                     <h1  class=" text-center font-weight-bold text-warning w3-blue">Personal Profile</h1>
...
//$email=$_SESSION['email'];
	...
	$edit_fname_query="select * from onlinehealthcare_form where email='sadiya@gmail.com'" ;
